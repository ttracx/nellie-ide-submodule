...
# It is used to define and reuse prompts within Nellie IDE
# Nellie IDE will automatically create a slash command for each prompt in the .prompts folder
# To learn more, see the full .prompt file reference: https://github.com/ttracx/nellie-ide/features/prompt-files
temperature: 0.0
---
{{{ diff }}}
