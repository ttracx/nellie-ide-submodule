...
1. Make sure you have the "Enable Tab Autocomplete" setting checked (in VS Code, you can toggle by clicking the "Nellie IDE" button in the status bar).
...
Click the "Nellie IDE" button in the status panel at the bottom right of the screen. The checkmark will become a "cancel" symbol and you will no longer see completions. You can click again to turn it back on.

Alternatively, open VS Code settings, search for "Nellie IDE" and uncheck the box for "Enable Tab Autocomplete".

### JetBrains

Open Settings -> Tools -> Nellie IDE and uncheck the box for "Enable Tab Autocomplete".
