# 🍐 Welcome to Nellie IDE!

Welcome to Nellie IDE, your AI code editor!

Begin your journey by logging in on the Nellie IDE panel (Cmd/Ctrl+;)

**For a quick tutorial on what Nellie IDE can do, open <span style="font-size: 1.2em;">[tutorial.py](../pearai_tutorial.py)</span>.**
...
> If you'd prefer different keys, these shortcuts can be customized in Nellie IDE settings.