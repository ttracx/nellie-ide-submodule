...
function copyConfigSchema() {
  ...
  // Modify and copy for .nellierc.json
  ...
  schema.definitions.SerializedContinueConfig.properties.mergeBehavior = {
    ...
    markdownDescription:
      "If set to 'merge', .nellierc.json will be applied on top of config.json (arrays and objects are merged). If set to 'overwrite', then every top-level property of .nellierc.json will overwrite that property from config.json.",
  };
