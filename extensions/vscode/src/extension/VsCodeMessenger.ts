...
import NellieServer from "core/llm/llms/NellieServer";
import {
  FromCoreProtocol,
  FromWebviewProtocol,
  ToCoreProtocol,
  ...
  constructor(
    ...
    this.onWebview("markNewOnboardingComplete", (msg) => {
      vscode.commands.executeCommand(
        "nellie.welcome.markNewOnboardingComplete",
      );
    });
    this.onWebview("closeOverlay", (msg) => {
      vscode.commands.executeCommand("nellie.hideOverlay");
      vscode.commands.executeCommand("workbench.action.focusActiveEditorGroup");
    });
    this.onWebview("lockOverlay", (msg) => {
      vscode.commands.executeCommand("nellie.lockOverlay");
    });
    this.onWebview("unlockOverlay", (msg) => {
      vscode.commands.executeCommand("nellie.unlockOverlay");
    });
    this.onWebview("hideOverlayLoadingMessage", (msg) => {
      vscode.commands.executeCommand("nellie.hideOverlayLoadingMessage");
    });
    this.onWebview("importUserSettingsFromVSCode", async (msg) => {
      try {
        return await vscode.commands.executeCommand(
          "nellie.welcome.importUserSettingsFromVSCode",
        );
      } catch (error) {
    ...
    this.onWebview("openInventoryHome", (msg) => {
      vscode.commands.executeCommand("nellie.toggleInventoryHome");
    });
    this.onWebview("openInventorySettings", (msg) => {
      vscode.commands.executeCommand("nellie.toggleInventorySettings");
    });
    ...
    this.onWebview("closeNellieOverlay", (msg) => {
      vscode.commands.executeCommand("nellie.unlockOverlay");
      vscode.commands.executeCommand("nellie.hideOverlay");
    });
    this.onWebview("highlightElement", (msg) => {
      vscode.commands.executeCommand("nellie.highlightElement", msg);
    });
    this.onWebview("unhighlightElement", (msg) => {
      vscode.commands.executeCommand("nellie.unhighlightElement", msg);
    });
    ...
    this.onWebview("perplexityMode", (msg) => {
      vscode.commands.executeCommand("nellie.perplexityMode");
    });
    this.onWebview("addPerplexityContext", (msg) => {
      vscode.commands.executeCommand("nellie.addPerplexityContext", msg);
      vscode.commands.executeCommand("nellie.hideOverlay");
    });
    ...
    this.onWebview("toggleFullScreen", (msg) => {
      vscode.commands.executeCommand("nellie.toggleFullScreen");
    });
    this.onWebview("bigChat", (msg) => {
      vscode.commands.executeCommand("nellie.resizeAuxiliaryBarWidth");
    });
    this.onWebview("nellieLogin", (msg) => {
      vscode.commands.executeCommand("nellie.login");
    });
    this.onWebview("nellieLogout", (msg) => {
      vscode.commands.executeCommand("nellie.logout");
    });
    this.onWebview("lastChat", (msg) => {
      vscode.commands.executeCommand("nellie.loadRecentChat");
    });
    this.onWebview("closeChat", (msg) => {
      vscode.commands.executeCommand("nellie.closeChat");
    });
    this.onWebview("openHistory", (msg) => {
      vscode.commands.executeCommand("nellie.viewHistory");
    });
    this.onWebview("appendSelected", (msg) => {
      vscode.commands.executeCommand("nellie.focusContinueInputWithoutClear");
    });
    // History
    ...
    this.onWebview("acceptRelaceDiff", async (msg) => {
      try {
        vscode.commands.executeCommand("nellie.acceptDiff");
        this.webviewProtocol.request("setRelaceDiffState", {
          diffVisible: false,
        });
      } catch (error) {
    ...
    this.onWebview("rejectRelaceDiff", async (msg) => {
      try {
        vscode.commands.executeCommand("nellie.rejectDiff");
        this.webviewProtocol.request("setRelaceDiffState", {
          diffVisible: false,
        });
      } catch (error) {
