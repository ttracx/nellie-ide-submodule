...
const TUTORIAL_FILE_NAME = "nellie_tutorial.py";
...
const actions: TutorialCodeLensItems[] = [
  {
    ...
    commands: [
      {
        title: `${cmdCtrl}+L`,
        command: "nellie.focusContinueInput",
      },
    ],
  },
  {
    ...
    commands: [
      {
        ...
        command: "nellie.sendMainUserInput",
