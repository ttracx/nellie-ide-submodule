      ...
      <div className="p-4">
        {!props.hideFreeTrialLimitMessage && hasPassedFTL() && (
          <p className="text-sm text-gray-500">
            ...
            free inputs. To keep using Nellie IDE, you can either use your own API
            key, or use a local LLM. To read more about the options, see our{" "}
            <a
              href="https://github.com/ttracx/nellie-ide/setup/overview"
              target="_blank"
              onClick={() =>
                ideMessenger.post(
                  "openUrl",
                  "https://github.com/ttracx/nellie-ide/setup/overview",
                )
              }
            >
              documentation
