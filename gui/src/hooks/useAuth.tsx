        ...
        if (!getLocalStorage("shownProfilesIntroduction")) {
          ...
          dispatch(
            setDialogMessage(
              <ConfirmationDialog
                text={
                  "Welcome to Nellie IDE for teams! Using the toggle in the bottom right, you can switch between your local profile (defined by config.json) and team profiles (defined in the Nellie IDE for teams web app). Each profile defines a set of models, slash commands, context providers, and other settings to customize Nellie IDE."
                }
    ...
    dispatch(
      setDialogMessage(
        <ConfirmationDialog
          ...
          text={"Are you sure you want to log out of Nellie IDE?"}
          onConfirm={() => {
