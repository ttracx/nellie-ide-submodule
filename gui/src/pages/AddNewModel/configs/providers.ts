...
export const providers: Partial<Record<ModelProvider, ProviderInfo>> = {
  nellie_server: {
    title: "Nellie IDE Server",
    provider: "nellie_server",
    refPage: "nellie_server",
    description:
  ...
  azure: {
    ...
    longDescription: `[Visit our documentation](https://github.com/ttracx/nellie-ide/reference/Model%20Providers/azure) for information on obtaining an API key.
...
After it's up and running, you can start using Nellie IDE.`,
    icon: "llamacpp.png",
    tags: [ModelProviderTags.Local, ModelProviderTags.OpenSource],
    packages: openSourceModels,
    collectInputFor: [...completionParamsInputsConfigs],
