...
export const models: { [key: string]: ModelPackage } = {
  nellie_model: {
    ...
    description:
      "Experience seamless, fully-managed LLM integration with Nellie IDE, featuring the most advanced and current best-in-market language model.",
    params: {
      model: "nellie_model",
