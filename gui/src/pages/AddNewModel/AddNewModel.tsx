      ...
      <GridDiv>
        {!showOtherProviders ? (
          <>
            <ModelCard
              key="nellie_server"
              title={providers["nellie_server"].title}
              description={providers["nellie_server"].description}
              tags={providers["nellie_server"].tags}
              icon={providers["nellie_server"].icon}
              onClick={(e) => {
                console.log(`/addModel/provider/nellie_server`);
                navigate(`/addModel/provider/nellie_server`);
              }}
            />
            <ModelCard
              key="other"
