            ...
            <>
                ...
                <CustomModelButton
                  ...
                  onClick={() =>
                    ideMessenger.post(
                      "openUrl",
                      "https://github.com/ttracx/nellie-ide/signin?callback=nellie://nellie.nellie/auth", // Change to http://localhost:3000 and run pear-landing-page repo to test locally
                    )
                  }
                >
                ...
                <small
                  ...
                  className="mx-3"
                >
                  Note: Having trouble logging in? Open Nellie IDE from the dashboard on the {' '}
                  <a href="https://github.com/ttracx/nellie-ide/dashboard" target="_blank" rel="noopener noreferrer">
                    website
                  </a>.
                  </small>
            </>
