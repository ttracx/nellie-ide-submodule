...
function HelpPage() {
  ...
  const [session, setSession] = useState(false); // this state specifically serves to manage "Login to Nellie IDE" text conditionally on auth status
    ...
    <div>
      ...
      <div className="flex flex-col items-center justify-center w-full">
        <ButtonContainer>
          ...
          >
            {session ? "Relogin to Nellie IDE" : "Login to Nellie IDE"}
          </StyledButton>
          <StyledLink
          ...
          <StyledLink
            ...
            href="https://github.com/ttracx/nellie-app/"
            target="_blank"
            themeType={themeType}
          >
            <span className="icon">
